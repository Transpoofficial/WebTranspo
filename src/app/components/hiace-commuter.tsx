      ...
      <Card className="bg-[#0897B1]">
        <CardContent className="flex flex-col md:flex-row items-stretch gap-x-6">
          <Image
            ...
            src="/images/hiace/commuter/commuter.jpg"
            alt="HIACE Commuter"
            width={500}
            height={500}
          />
          ...
          <div className="flex flex-col gap-y-2 w-full mt-4">
            ...
            <div className="grow flex flex-col justify-between mt-1">
              ...
              <ul className="mt-1 mb-6 ml-6 list-disc text-base md:text-xl text-white">
                ...
                <li>
                  Harga sewa ekonomis untuk ukuran mobil besar, mulai 999.000
                  per hari.
                </li>
              ...
              <OrderButton content="hiace commuter" type="TRANSPORT" />
            </div>
          </div>
        </CardContent>
      </Card>
