...
export default function EditAchievementPage() {
  ...
  const { data: achievement, isLoading: isFetching } = useQuery<Achievement>({
  ...
  useEffect(() => {
    if (achievement) {
      setFormData({
        ...
        displayOrder: achievement.displayOrder.toString(),
        isActive: achievement.isActive,
      });
      setCurrentLogoUrl(achievement.logoUrl);
    }
  }, [achievement]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Toast loading
      toast.loading("Updating achievement...", { id: "update-progress" });

      // Send request using Axios
      await axios.put(`/api/achievements/${achievementId}`, formDataToSend, {
        headers: {
      ...
      let errorMessage = "An error occurred while updating achievement";
  ...
  return (
    <div className="container mx-auto py-6 px-4 max-w-4xl">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl">Edit Achievement</CardTitle>
          <CardDescription>
            Update achievement information displayed on the landing page
          </CardDescription>
        </CardHeader>
        <CardContent>
