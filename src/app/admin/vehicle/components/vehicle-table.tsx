      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="w-2/12">Seat count</TableHead>
            <TableHead className="w-3/12">Vehicle type</TableHead>
            <TableHead className="w-full">Additional details</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {data.map((row, index) => {
