...
export default function CreateTrustedByPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Toast loading
      toast.loading("Creating trusted partner...", { id: "upload-progress" });

      // Send request using Axios
      await axios.post("/api/trusted-by", formDataToSend, {
        headers: {
      ...
      // Success toast
      toast.success("Trusted partner created successfully!", {
        id: "upload-progress",
      });
      ...
      let errorMessage = "An error occurred while creating trusted partner";
  ...
  return (
    <div className="container mx-auto py-6 px-4 max-w-4xl">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl">Add Trusted Partner</CardTitle>
          <CardDescription>
            Add a new trusted partner to display on the landing page
          </CardDescription>
        </CardHeader>
        <CardContent>
